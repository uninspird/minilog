...
<div id="wrapper">
	...
	if(isset($_POST['submit'])){
		...
		if(!isset($error)){
			...
			try {
				...
				$stmt = $db->prepare('INSERT INTO blog_posts (postTitle,postDesc,postCont,postDate,isDraft) VALUES (:postTitle, :postDesc, :postCont, :postDate, :isDraft)') ;
				$draft = 0;
	...
	<form action='' method='post'>
		...
		<input type="checkbox" name="isDraft"> Draft <br>
